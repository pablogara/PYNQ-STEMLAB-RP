...
proc create_root_design { parentCell } {
  ...
  set led_8bit [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 led_8bit ]
  ...
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {led_8bit} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports led_8bit] [get_bd_intf_pins axi_gpio_0/GPIO]
